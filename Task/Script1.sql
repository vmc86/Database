...
Создать представление на основе таблиц
	1. покупки
		дата-время, продукт-название, цена общая (количество*цена), продавец-название
	2. продажи
		дата-время, продукт-название, цена общая (количество*цена), покупатель-название
	3. продажи на сумму больше 5000
	4. покупки за последнюю неделю
